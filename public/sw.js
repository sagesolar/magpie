...
const API_ENDPOINTS = ['/api/books', '/api/search', '/api/external'];
...
function isImageRequest(request) {
  ...
  return (
    imageHosts.some(host => url.hostname.includes(host)) ||
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification('Magpie Book Collection', options));
});
